...
vlog -work xpm  -sv2k12 "+incdir+../../../../fpga4fun_pong_vivado.gen/sources_1/bd/clk_108mhz/ipshared/6dcf" \
"/opt/Xilinx/Vivado/2021.1/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \

vcom -work xpm -93 \
"/opt/Xilinx/Vivado/2021.1/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work xil_defaultlib  -v2k5 "+incdir+../../../../fpga4fun_pong_vivado.gen/sources_1/bd/clk_108mhz/ipshared/6dcf" \
